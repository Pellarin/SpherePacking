...
topologies["POPC"]["BEADS"].append("   1 	Q0 	 1 	POPC 	NC3 	 1 	1.0 	".split())
topologies["POPC"]["BEADS"].append("   2 	Qa 	 1 	POPC 	PO4 	 2 	-1.0 	".split())
topologies["POPC"]["BEADS"].append("   3 	Na 	 1 	POPC 	GL1 	 3 	0 	    ".split())
topologies["POPC"]["BEADS"].append("   4 	Na 	 1 	POPC 	GL2 	 4 	0 	    ".split())
topologies["POPC"]["BEADS"].append("   5 	C1 	 1 	POPC 	C1A 	 5 	0 	    ".split())
topologies["POPC"]["BEADS"].append("   6 	C3 	 1 	POPC 	D2A 	 6 	0 	    ".split())
topologies["POPC"]["BEADS"].append("   7 	C1 	 1 	POPC 	C3A 	 7 	0 	    ".split())
topologies["POPC"]["BEADS"].append("   8 	C1 	 1 	POPC 	C4A 	 8 	0 	    ".split())
topologies["POPC"]["BEADS"].append("   9 	C1 	 1 	POPC 	C1B 	 9 	0 	    ".split())
topologies["POPC"]["BEADS"].append("  10 	C1 	 1 	POPC 	C2B 	10 	0 	    ".split())
topologies["POPC"]["BEADS"].append("  11 	C1 	 1 	POPC 	C3B 	11 	0 	    ".split())
topologies["POPC"]["BEADS"].append("  12 	C1 	 1 	POPC 	C4B 	12 	0 	    ".split())
...
for n,v in enumerate(heads):
    ...
    build.init_molecule("POPC",*v,2.3,True)
...
rh = RMF.create_rmf_file("POPC.sphere.rmf")
IMP.rmf.add_hierarchies(rh, [hroot])
IMP.rmf.add_restraints(rh, build.rs)
